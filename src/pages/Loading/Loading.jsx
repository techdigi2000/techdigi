        ...
        <body>
          ...
          <main className="vertical">
            <center>
              ...
              <br />
              <img
                src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExY2VjaHdmMTcybzc5b3hwMXd2bWt3MjU1NGlibjVlendrYzdnM2tzZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3oEjI6SIIHBdRxXI40/giphy.webp"
                width="200px"
              />
